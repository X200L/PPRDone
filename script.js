...
fetch('scenarios.json')
    ...
    .then(data => {
        ...
        // Инициализация кнопок сценариев после загрузки данных
        initializeScenarioButtons();
    })
    .catch(error => console.error('Ошибка загрузки сценариев:', error));

// Инициализация кнопок сценариев
...
function endScenario() {
    responseOptions.innerHTML = '<button class="scenario-btn" onclick="location.reload()">Начать заново</button>';
